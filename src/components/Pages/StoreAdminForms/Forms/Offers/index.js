...
import { getOffers, addProduct } from './../../../../../api';
                ...
                <tbody>
                  {this.state.data && this.state.data.length ?
                    this.state.data.map((d, i) =>
                      <tr key={i}>
                        <td style={{ width: '200px' }}>{d.offer_name}</td>
                        <td style={{ width: '300px' }}>{d.offer_description}</td>
                        <td style={{ width: '100px' }}>{d.offer_message}</td>
                        <td style={{ width: '100px' }}>{d.total_count}</td>
                        <td style={{ width: '100px' }}>{d.created_on}</td>
                        <td style={{ width: '100px' }}>{d.expires_on}</td>
                        <td style={{ width: '100px' }}>{d.product_offered}</td>
                        <td style={{ width: '100px' }}>{d.discount_percent}</td>
                        <td style={{ width: '100px' }}>{d.max_discount}</td>
                        <td style={{ width: '100px' }}>{d.offer_starts_on}</td>
                        <td style={{ width: '100px' }}>{d.offer_hours}</td>
                        <td style={{ width: '100px' }}>{d.updated_on}</td>
                        <td style={{ width: '100px' }}>{d.updated_by}</td>
                        <td>
